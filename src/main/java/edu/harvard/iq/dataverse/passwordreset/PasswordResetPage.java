...
public class PasswordResetPage implements java.io.Serializable {
    ...
    public String getCustomPasswordResetAlertIntro() {
        String customPasswordResetAlertIntro = settingsWrapper.getValueForKey(SettingsServiceBean.Key.PVCustomPasswordResetAlertIntro);
        if(customPasswordResetAlertIntro != null && !customPasswordResetAlertIntro.isEmpty()){
            return customPasswordResetAlertIntro;
        } else {
            String defaultPasswordResetAlertIntro = BundleUtil.getStringFromBundle("passwdReset.alert.intro");
            return defaultPasswordResetAlertIntro;
        }
    }
}
